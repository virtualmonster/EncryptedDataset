...
public class MakeBookingSchedule_Schedule_A1EA348367E54420E162E16339653262
		extends com.ibm.rational.test.lt.kernel.action.impl.Schedule {

	public MakeBookingSchedule_Schedule_A1EA348367E54420E162E16339653262(IContainer parent, String name) {
		super(parent, name, "A1EA348367E54420E162E16339653262");
		setThinkMax(10000);
	...
	public class UserGroup_1 extends UserGroup {
		...
		public UserGroup_1(IContainer parent) {
			super(parent, "User Group 1", "A1EA348367E9B0F4E162E16339653262");
		...
		private Container scenario_1(IContainer parent) {
			Container scenario = new Container(parent, "Default Scenario", "A1EA348367E9B0FFE162E16339653262") {
				...
				public void execute() {
					...
					IContainer testMethod_1 = (IContainer) loadTest(this, "vBooking_WebUI",
							...
							"A1EA34837842DF30E162E16339653262");
